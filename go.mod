...
// These replaces mirror github.com/kommodity-io/kommodity's go.mod. Go module
// replace directives do not propagate to consumers, so they must be repeated
// here: k8s.io/kubernetes's go.mod points these at its private staging dirs.
...
require (
	...
	github.com/kommodity-io/kommodity v0.154.1-0.20260731172225-39d005305dee
